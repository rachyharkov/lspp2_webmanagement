...
<head>
    ...
    <title>Login - LSPP2 Pupuk Indonesia Web Management</title>
            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block" style="background:url(./assets/images/logo-brand.png) no-repeat;background-position: center;background-size: 14rem 14rem; position: relative;">
                            	<p style="position: absolute;
bottom: 0;
width: 100%;
text-align: center;">LSPP2 PI Web Management System</p>
                            </div>
                            <div class="col-lg-6">
                                <div class="p-5">
